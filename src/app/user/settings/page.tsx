    ...
    <div className="mx-auto max-w-2xl space-y-6">
        ...
        <form onSubmit={handleProfileSave} className="space-y-4 p-6">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="h-10 border-slate-200 text-sm focus-visible:ring-indigo-500"
            />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="flex justify-end pt-1">
            <Button
              ...
              className="h-9 rounded-lg bg-indigo-600 px-5 text-xs font-semibold text-white shadow-sm shadow-indigo-500/20 transition-all hover:bg-indigo-700 hover:shadow-md"
            >
      ...
      <div className="rounded-xl bg-white shadow-sm ring-1 ring-slate-900/5">
        ...
        <form onSubmit={handlePasswordSave} className="space-y-4 p-6">
          {/* Current password */}
          <div className="space-y-1.5">
            <Label htmlFor="current-pw" className="text-xs font-semibold uppercase tracking-wide text-slate-500">Current password</Label>
            <div className="relative">
              <Input
                ...
                className="h-10 border-slate-200 pr-10 text-sm focus-visible:ring-indigo-500"
              />
          ...
          {/* New password */}
          <div className="space-y-1.5">
            <Label htmlFor="new-pw" className="text-xs font-semibold uppercase tracking-wide text-slate-500">New password</Label>
            <div className="relative">
              <Input
                id="new-pw"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="confirm-pw" className="text-xs font-semibold uppercase tracking-wide text-slate-500">Confirm new password</Label>
            <div className="relative">
              <Input
                id="confirm-pw"
                ...
                className={`h-10 border-slate-200 pr-10 text-sm focus-visible:ring-indigo-500 ${confirmPw && confirmPw !== newPw ? "border-red-300 bg-red-50/30" : ""}`}
              />
          ...
          <div className="flex justify-end pt-1">
            <Button
              type="submit"
              disabled={savingPw}
              className="h-9 rounded-lg bg-amber-500 px-5 text-xs font-semibold text-white shadow-sm shadow-amber-500/20 transition-all hover:bg-amber-600 hover:shadow-md"
            >
